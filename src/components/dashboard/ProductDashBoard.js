...
export default function ProductDashBoard() {
    ...
    const url = "https://fusiontech-0dxp.onrender.com/api/v1/VideoGamesInfo/Detailed?MinPrice=0&MaxPrice=1000&Limit=100&Offset=0";
    ...
    useEffect(() => {
        axios.get("https://fusiontech-0dxp.onrender.com/api/v1/Publisher")
            .then((response) => setPublishers(response.data))
            .catch((error) => console.error("Error fetching publishers", error));

        axios.get("https://fusiontech-0dxp.onrender.com/api/v1/Categories")
            .then((response) => setCategories(response.data))
            .catch((error) => console.error("Error fetching categories", error));

        axios.get("https://fusiontech-0dxp.onrender.com/api/v1/GameStudio")
            .then((response) => setStudios(response.data))
            .catch((error) => console.error("Error fetching studios", error));

        axios.get("https://fusiontech-0dxp.onrender.com/api/v1/Console")
    ...
    const handleCreateProduct = async () => {
        ...
        try {
            ...
            await axios.post('https://fusiontech-0dxp.onrender.com/api/v1/VideoGamesInfo', newProduct, {
                headers: {
